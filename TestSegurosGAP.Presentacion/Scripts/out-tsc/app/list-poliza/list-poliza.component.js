...
var ListClientComponent = /** @class */ (function () {
    ...
    ListClientComponent.prototype.viewInsuranceClient = function (client) {
        var _this = this;
        this.apiService.getInsurancesClient(client.IdCliente)
            .subscribe(function (data) {
            _this.clients = _this.clients.filter(function (u) { return u !== client; });
        });
    };
    ;
